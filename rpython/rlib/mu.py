...
# rffi can't deal with recursive struct definitions
# values need to be casted when passing argument and accessing return result.
_MuVMPtr = rffi.VOIDP
_MuCtxPtr = rffi.VOIDP
...
MuVM = rffi.CStruct('MuVM',
                    ('header', rffi.VOIDP),
                    ('new_context', _fnp([_MuVMPtr], _MuCtxPtr)),
                    ('id_of', _fnp([_MuVMPtr, MuName], MuID)),
                    ('name_of', _fnp([_MuVMPtr, MuID], MuName)),
                    ('set_trap_handler', _fnp([_MuVMPtr, MuTrapHandler, MuCPtr], lltype.Void)),
                    ('execute', _fnp([_MuVMPtr], lltype.Void)),
                    ('get_mu_error_ptr', _fnp([_MuVMPtr], rffi.INTP))
)
...
MuCtx = rffi.CStruct(
    ...
    ('load', rffi.CCallback([_MuCtxPtr, MuMemOrd._lltype, MuIRefValue], MuValue)),
    ('store', rffi.CCallback([_MuCtxPtr, MuMemOrd._lltype, MuIRefValue, MuValue], lltype.Void)),
    ('cmpxchg',
     rffi.CCallback([_MuCtxPtr, MuMemOrd._lltype, MuMemOrd._lltype, MuBool, MuIRefValue, MuValue, MuValue, MuBoolPtr],
                    MuValue)),
    (
    'atomicrmw', rffi.CCallback([_MuCtxPtr, MuMemOrd._lltype, MuAtomicRMWOptr._lltype, MuIRefValue, MuValue], MuValue)),
    ('fence', rffi.CCallback([_MuCtxPtr, MuMemOrd._lltype], lltype.Void)),
    ('new_stack', rffi.CCallback([_MuCtxPtr, MuFuncRefValue], MuStackRefValue)),
    ('new_thread_nor',
     rffi.CCallback([_MuCtxPtr, MuStackRefValue, MuRefValue, MuValuePtr, MuArraySize], MuThreadRefValue)),
    ...
    ('expose', rffi.CCallback([_MuCtxPtr, MuFuncRefValue, MuCallConv._lltype, MuIntValue], MuValue)),
    ('unexpose', rffi.CCallback([_MuCtxPtr, MuCallConv._lltype, MuValue], lltype.Void)),
    ('new_bundle', rffi.CCallback([_MuCtxPtr], MuBundleNode)),
    ('load_bundle_from_node', rffi.CCallback([_MuCtxPtr, MuBundleNode], lltype.Void)),
    ('abort_bundle_node', rffi.CCallback([_MuCtxPtr, MuBundleNode], lltype.Void)),
    ('get_node', rffi.CCallback([_MuCtxPtr, MuBundleNode, MuID], MuChildNode)),
    ('get_id', rffi.CCallback([_MuCtxPtr, MuBundleNode, MuChildNode], MuID)),
    ('set_name', rffi.CCallback([_MuCtxPtr, MuBundleNode, MuChildNode, MuName], lltype.Void)),
    ('new_type_int', rffi.CCallback([_MuCtxPtr, MuBundleNode, rffi.INT], MuTypeNode)),
    ('new_type_float', rffi.CCallback([_MuCtxPtr, MuBundleNode], MuTypeNode)),
    ('new_type_double', rffi.CCallback([_MuCtxPtr, MuBundleNode], MuTypeNode)),
    ('new_type_uptr', rffi.CCallback([_MuCtxPtr, MuBundleNode], MuTypeNode)),
    ('set_type_uptr', rffi.CCallback([_MuCtxPtr, MuTypeNode, MuTypeNode], lltype.Void)),
    ('new_type_ufuncptr', rffi.CCallback([_MuCtxPtr, MuBundleNode], MuTypeNode)),
    ('set_type_ufuncptr', rffi.CCallback([_MuCtxPtr, MuTypeNode, MuFuncSigNode], lltype.Void)),
    ('new_type_struct', rffi.CCallback([_MuCtxPtr, MuBundleNode, MuTypeNodePtr, MuArraySize], MuTypeNode)),
    ('new_type_hybrid', rffi.CCallback([_MuCtxPtr, MuBundleNode, MuTypeNodePtr, MuArraySize, MuTypeNode], MuTypeNode)),
    ('new_type_array', rffi.CCallback([_MuCtxPtr, MuBundleNode, MuTypeNode, rffi.ULONG], MuTypeNode)),
    ('new_type_vector', rffi.CCallback([_MuCtxPtr, MuBundleNode, MuTypeNode, rffi.ULONG], MuTypeNode)),
    ('new_type_void', rffi.CCallback([_MuCtxPtr, MuBundleNode], MuTypeNode)),
    ('new_type_ref', rffi.CCallback([_MuCtxPtr, MuBundleNode], MuTypeNode)),
    ('set_type_ref', rffi.CCallback([_MuCtxPtr, MuTypeNode, MuTypeNode], lltype.Void)),
    ('new_type_iref', rffi.CCallback([_MuCtxPtr, MuBundleNode], MuTypeNode)),
    ('set_type_iref', rffi.CCallback([_MuCtxPtr, MuTypeNode, MuTypeNode], lltype.Void)),
    ('new_type_weakref', rffi.CCallback([_MuCtxPtr, MuBundleNode], MuTypeNode)),
    ('set_type_weakref', rffi.CCallback([_MuCtxPtr, MuTypeNode, MuTypeNode], lltype.Void)),
    ('new_type_funcref', rffi.CCallback([_MuCtxPtr, MuBundleNode], MuTypeNode)),
    ('set_type_funcref', rffi.CCallback([_MuCtxPtr, MuTypeNode, MuFuncSigNode], lltype.Void)),
    ('new_type_tagref64', rffi.CCallback([_MuCtxPtr, MuBundleNode], MuTypeNode)),
    ('new_type_threadref', rffi.CCallback([_MuCtxPtr, MuBundleNode], MuTypeNode)),
    ('new_type_stackref', rffi.CCallback([_MuCtxPtr, MuBundleNode], MuTypeNode)),
    ('new_type_framecursorref', rffi.CCallback([_MuCtxPtr, MuBundleNode], MuTypeNode)),
    ('new_type_irnoderef', rffi.CCallback([_MuCtxPtr, MuBundleNode], MuTypeNode)),
    ('new_funcsig',
     rffi.CCallback([_MuCtxPtr, MuBundleNode, MuTypeNodePtr, MuArraySize, MuTypeNodePtr, MuArraySize], MuFuncSigNode)),
    ('new_const_int', rffi.CCallback([_MuCtxPtr, MuBundleNode, MuTypeNode, rffi.ULONG], MuConstNode)),
    ('new_const_int_ex', rffi.CCallback([_MuCtxPtr, MuBundleNode, MuTypeNode, rffi.ULONGP, MuArraySize], MuConstNode)),
    ('new_const_float', rffi.CCallback([_MuCtxPtr, MuBundleNode, MuTypeNode, rffi.FLOAT], MuConstNode)),
    ('new_const_double', rffi.CCallback([_MuCtxPtr, MuBundleNode, MuTypeNode, rffi.DOUBLE], MuConstNode)),
    ('new_const_null', rffi.CCallback([_MuCtxPtr, MuBundleNode, MuTypeNode], MuConstNode)),
    ('new_const_seq', rffi.CCallback([_MuCtxPtr, MuBundleNode, MuTypeNode, MuConstNodePtr, MuArraySize], MuConstNode)),
    ('new_global_cell', rffi.CCallback([_MuCtxPtr, MuBundleNode, MuTypeNode], MuGlobalNode)),
    ('new_func', rffi.CCallback([_MuCtxPtr, MuBundleNode, MuFuncSigNode], MuFuncNode)),
    ('new_func_ver', rffi.CCallback([_MuCtxPtr, MuBundleNode, MuFuncNode], MuFuncVerNode)),
    ('new_exp_func',
     rffi.CCallback([_MuCtxPtr, MuBundleNode, MuFuncNode, MuCallConv._lltype, MuConstNode], MuExpFuncNode)),
    ('new_bb', rffi.CCallback([_MuCtxPtr, MuFuncVerNode], MuBBNode)),
    ('new_nor_param', rffi.CCallback([_MuCtxPtr, MuBBNode, MuTypeNode], MuNorParamNode)),
    ('new_exc_param', rffi.CCallback([_MuCtxPtr, MuBBNode], MuExcParamNode)),
    ('new_inst_res', rffi.CCallback([_MuCtxPtr, MuInstNode], MuInstResNode)),
    ('add_dest',
     rffi.CCallback([_MuCtxPtr, MuInstNode, MuDestKind._lltype, MuBBNode, MuVarNodePtr, MuArraySize], lltype.Void)),
    ('add_keepalives', rffi.CCallback([_MuCtxPtr, MuInstNode, MuLocalVarNodePtr, MuArraySize], lltype.Void)),
    ('new_binop',
     rffi.CCallback([_MuCtxPtr, MuBBNode, MuBinOptr._lltype, MuTypeNode, MuVarNode, MuVarNode], MuInstNode)),
    ('new_cmp', rffi.CCallback([_MuCtxPtr, MuBBNode, MuCmpOptr._lltype, MuTypeNode, MuVarNode, MuVarNode], MuInstNode)),
    ('new_conv',
     rffi.CCallback([_MuCtxPtr, MuBBNode, MuConvOptr._lltype, MuTypeNode, MuTypeNode, MuVarNode], MuInstNode)),
    ('new_select',
     rffi.CCallback([_MuCtxPtr, MuBBNode, MuTypeNode, MuTypeNode, MuVarNode, MuVarNode, MuVarNode], MuInstNode)),
    ('new_branch', rffi.CCallback([_MuCtxPtr, MuBBNode], MuInstNode)),
    ('new_branch2', rffi.CCallback([_MuCtxPtr, MuBBNode, MuVarNode], MuInstNode)),
    ('new_switch', rffi.CCallback([_MuCtxPtr, MuBBNode, MuTypeNode, MuVarNode], MuInstNode)),
    ('add_switch_dest',
     rffi.CCallback([_MuCtxPtr, MuInstNode, MuConstNode, MuBBNode, MuVarNodePtr, MuArraySize], lltype.Void)),
    (
    'new_call', rffi.CCallback([_MuCtxPtr, MuBBNode, MuFuncSigNode, MuVarNode, MuVarNodePtr, MuArraySize], MuInstNode)),
    ('new_tailcall',
     rffi.CCallback([_MuCtxPtr, MuBBNode, MuFuncSigNode, MuVarNode, MuVarNodePtr, MuArraySize], MuInstNode)),
    ('new_ret', rffi.CCallback([_MuCtxPtr, MuBBNode, MuVarNodePtr, MuArraySize], MuInstNode)),
    ('new_throw', rffi.CCallback([_MuCtxPtr, MuBBNode, MuVarNode], MuInstNode)),
    ('new_extractvalue', rffi.CCallback([_MuCtxPtr, MuBBNode, MuTypeNode, rffi.INT, MuVarNode], MuInstNode)),
    ('new_insertvalue', rffi.CCallback([_MuCtxPtr, MuBBNode, MuTypeNode, rffi.INT, MuVarNode, MuVarNode], MuInstNode)),
    ('new_extractelement',
     rffi.CCallback([_MuCtxPtr, MuBBNode, MuTypeNode, MuTypeNode, MuVarNode, MuVarNode], MuInstNode)),
    ('new_insertelement',
     rffi.CCallback([_MuCtxPtr, MuBBNode, MuTypeNode, MuTypeNode, MuVarNode, MuVarNode, MuVarNode], MuInstNode)),
    ('new_shufflevector',
     rffi.CCallback([_MuCtxPtr, MuBBNode, MuTypeNode, MuTypeNode, MuVarNode, MuVarNode, MuVarNode], MuInstNode)),
    ('new_new', rffi.CCallback([_MuCtxPtr, MuBBNode, MuTypeNode], MuInstNode)),
    ('new_newhybrid', rffi.CCallback([_MuCtxPtr, MuBBNode, MuTypeNode, MuTypeNode, MuVarNode], MuInstNode)),
    ('new_alloca', rffi.CCallback([_MuCtxPtr, MuBBNode, MuTypeNode], MuInstNode)),
    ('new_allocahybrid', rffi.CCallback([_MuCtxPtr, MuBBNode, MuTypeNode, MuTypeNode, MuVarNode], MuInstNode)),
    ('new_getiref', rffi.CCallback([_MuCtxPtr, MuBBNode, MuTypeNode, MuVarNode], MuInstNode)),
    ('new_getfieldiref', rffi.CCallback([_MuCtxPtr, MuBBNode, MuBool, MuTypeNode, rffi.INT, MuVarNode], MuInstNode)),
    ('new_getelemiref',
     rffi.CCallback([_MuCtxPtr, MuBBNode, MuBool, MuTypeNode, MuTypeNode, MuVarNode, MuVarNode], MuInstNode)),
    ('new_shiftiref',
     rffi.CCallback([_MuCtxPtr, MuBBNode, MuBool, MuTypeNode, MuTypeNode, MuVarNode, MuVarNode], MuInstNode)),
    ('new_getvarpartiref', rffi.CCallback([_MuCtxPtr, MuBBNode, MuBool, MuTypeNode, MuVarNode], MuInstNode)),
    ('new_load', rffi.CCallback([_MuCtxPtr, MuBBNode, MuBool, MuMemOrd._lltype, MuTypeNode, MuVarNode], MuInstNode)),
    ('new_store',
     rffi.CCallback([_MuCtxPtr, MuBBNode, MuBool, MuMemOrd._lltype, MuTypeNode, MuVarNode, MuVarNode], MuInstNode)),
    ('new_cmpxchg', rffi.CCallback(
        [_MuCtxPtr, MuBBNode, MuBool, MuBool, MuMemOrd._lltype, MuMemOrd._lltype, MuTypeNode, MuVarNode, MuVarNode,
         MuVarNode], MuInstNode)),
    ('new_atomicrmw', rffi.CCallback(
        [_MuCtxPtr, MuBBNode, MuBool, MuMemOrd._lltype, MuAtomicRMWOptr._lltype, MuTypeNode, MuVarNode, MuVarNode],
        MuInstNode)),
    ('new_fence', rffi.CCallback([_MuCtxPtr, MuBBNode, MuMemOrd._lltype], MuInstNode)),
    ('new_trap', rffi.CCallback([_MuCtxPtr, MuBBNode, MuTypeNodePtr, MuArraySize], MuInstNode)),
    ('new_watchpoint', rffi.CCallback([_MuCtxPtr, MuBBNode, MuWPID, MuTypeNodePtr, MuArraySize], MuInstNode)),
    ('new_wpbranch', rffi.CCallback([_MuCtxPtr, MuBBNode, MuWPID], MuInstNode)),
    ('new_ccall', rffi.CCallback(
        [_MuCtxPtr, MuBBNode, MuCallConv._lltype, MuTypeNode, MuFuncSigNode, MuVarNode, MuVarNodePtr, MuArraySize],
        MuInstNode)),
    ('new_newthread', rffi.CCallback([_MuCtxPtr, MuBBNode, MuVarNode, MuVarNode], MuInstNode)),
    ('new_swapstack_ret', rffi.CCallback([_MuCtxPtr, MuBBNode, MuVarNode, MuTypeNodePtr, MuArraySize], MuInstNode)),
    ('new_swapstack_kill', rffi.CCallback([_MuCtxPtr, MuBBNode, MuVarNode], MuInstNode)),
    ('set_newstack_pass_values',
     rffi.CCallback([_MuCtxPtr, MuInstNode, MuTypeNodePtr, MuVarNodePtr, MuArraySize], lltype.Void)),
    ('set_newstack_throw_exc', rffi.CCallback([_MuCtxPtr, MuInstNode, MuVarNode], lltype.Void)),
    ('new_comminst', rffi.CCallback(
        [_MuCtxPtr, MuBBNode, MuCommInst._lltype, MuFlagPtr, MuArraySize, MuTypeNodePtr, MuArraySize, MuFuncSigNodePtr,
